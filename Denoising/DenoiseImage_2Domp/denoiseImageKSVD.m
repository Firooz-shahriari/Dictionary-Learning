...
function [IOut,output] = denoiseImageKSVD(Image,sigma,K,iteration,varargin)
%==========================================================================
...
% param.initialDictionary = normc(randn(bb^2,param.K));
...
%     for kk = 1:jumpSize
%      Coefs(:,kk) = SL0(Dictionary,blocks(:,jj+kk-1),1,.8);
%     end
%     
%      tmp           = Coefs;
%      tmp(tmp<5)    = 0;
